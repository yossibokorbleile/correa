...
struct \mbox{\hyperlink{structis__final}{is\+\_\+final}}
\begin{DoxyCompactList}\small\item\em Annotation for classes that cannot be subclassed. \end{DoxyCompactList}\item 
...
struct \mbox{\hyperlink{structcustom__type__setup}{custom\+\_\+type\+\_\+setup}}
\item 
...
struct \mbox{\hyperlink{structprepend}{prepend}}
\begin{DoxyCompactList}\small\item\em Mark a function for addition at the beginning of the existing overload chain instead of the end. \end{DoxyCompactList}\item 
...
\item 
struct \mbox{\hyperlink{structkw__only}{kw\+\_\+only}}
\item 
struct \mbox{\hyperlink{structpos__only}{pos\+\_\+only}}
