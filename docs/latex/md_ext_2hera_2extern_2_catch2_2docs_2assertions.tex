...
\Hypertarget{index_top}%
 \hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md8}{}\doxysection{Assertion Macros}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md8}
{\bfseries{Contents}}~\newline
 Natural Expressions~\newline
 Exceptions~\newline
 Matcher expressions~\newline
...
Most of these macros come in two forms\+:\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md9}{}\doxysubsection{Natural Expressions}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md9}
...
\begin{DoxyItemize}
\item {\bfseries{REQUIRE($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}} and ~\newline

\item {\bfseries{CHECK($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries{REQUIRE\+\_\+\+FALSE($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}} and ~\newline

\item {\bfseries{CHECK\+\_\+\+FALSE($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}}
\end{DoxyItemize}
...
\item {\ttfamily CHECK( a == 2 $\vert$$\vert$ b == 1 );} This expression is too complex because of the {\ttfamily $\vert$$\vert$} operator. If you want to check that one of several properties hold, you can put the expression into parenthesis (unlike with {\ttfamily \&\&}, expression decomposition into several {\ttfamily CHECK}s is not possible).
\end{DoxyItemize}\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md10}{}\doxysubsubsection{Floating point comparisons}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md10}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{REQUIRE(\ performComputation()\ ==\ \mbox{\hyperlink{catch__amalgamated_8hpp_a9f3b477eb84f043a6f954e26f511e8ab}{Approx}}(\ 2.1\ )\ );}
...
\begin{DoxyItemize}
\item {\bfseries{epsilon}} -\/ epsilon serves to set the coefficient by which a result can differ from {\ttfamily Approx}\textquotesingle{}s value before it is rejected. {\itshape By default set to {\ttfamily std\+::numeric\+\_\+limits\texorpdfstring{$<$}{<}float\texorpdfstring{$>$}{>}::epsilon()$\ast$100}.}
...
\end{DoxyItemize}\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md11}{}\doxyparagraph{epsilon example}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md11}

\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{class_catch_1_1_approx}{Approx}}\ target\ =\ \mbox{\hyperlink{class_catch_1_1_approx}{Approx}}(100).epsilon(0.01);}
...
\end{DoxyCode}
\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md12}{}\doxyparagraph{margin example}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md12}

\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{class_catch_1_1_approx}{Approx}}\ target\ =\ \mbox{\hyperlink{class_catch_1_1_approx}{Approx}}(100).margin(5);}
\DoxyCodeLine{100.0\ ==\ target;\ \textcolor{comment}{//\ Obviously\ true}}
\DoxyCodeLine{200.0\ ==\ target;\ \textcolor{comment}{//\ Obviously\ still\ false}}
\DoxyCodeLine{104.0\ ==\ target;\ \textcolor{comment}{//\ True,\ because\ we\ set\ target\ to\ allow\ absolute\ difference\ of\ at\ most\ 5}}

\end{DoxyCode}
\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md13}{}\doxyparagraph{scale}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md13}
Scale can be useful if the computation leading to the result worked on different scale than is used by the results. Since allowed difference between Approx\textquotesingle{}s value and compared value is based primarily on Approx\textquotesingle{}s value (the allowed difference is computed as {\ttfamily (Approx\+::scale + Approx\+::value) $\ast$ epsilon}), the resulting comparison could need rescaling to be correct.\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md14}{}\doxysubsection{Exceptions}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md14}

\begin{DoxyItemize}
\item {\bfseries{REQUIRE\+\_\+\+NOTHROW($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}} and ~\newline

\item {\bfseries{CHECK\+\_\+\+NOTHROW($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries{REQUIRE\+\_\+\+THROWS($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}} and ~\newline

\item {\bfseries{CHECK\+\_\+\+THROWS($\ast$$\ast$ {\itshape expression} $\ast$$\ast$)}}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries{REQUIRE\+\_\+\+THROWS\+\_\+\+AS($\ast$$\ast$ {\itshape expression}, {\itshape exception type} $\ast$$\ast$)}} and ~\newline

\item {\bfseries{CHECK\+\_\+\+THROWS\+\_\+\+AS($\ast$$\ast$ {\itshape expression}, {\itshape exception type} $\ast$$\ast$)}}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries{REQUIRE\+\_\+\+THROWS\+\_\+\+WITH($\ast$$\ast$ {\itshape expression}, {\itshape string or string matcher} $\ast$$\ast$)}} and ~\newline

\item {\bfseries{CHECK\+\_\+\+THROWS\+\_\+\+WITH($\ast$$\ast$ {\itshape expression}, {\itshape string or string matcher} $\ast$$\ast$)}}
\end{DoxyItemize}
...
e.\+g. 
\begin{DoxyCode}{0}
\DoxyCodeLine{REQUIRE\_THROWS\_WITH(\ openThePodBayDoors(),\ \mbox{\hyperlink{catch__amalgamated_8hpp_a057dc1a49cb5aef983e293c86816c239}{Contains}}(\ \textcolor{stringliteral}{"{}afraid"{}}\ )\ \&\&\ \mbox{\hyperlink{catch__amalgamated_8hpp_a057dc1a49cb5aef983e293c86816c239}{Contains}}(\ \textcolor{stringliteral}{"{}can't\ do\ that"{}}\ )\ );}
...
\begin{DoxyItemize}
\item {\bfseries{REQUIRE\+\_\+\+THROWS\+\_\+\+MATCHES($\ast$$\ast$ {\itshape expression}, {\itshape exception type}, {\itshape matcher for given exception type} $\ast$$\ast$)}} and
\item {\bfseries{CHECK\+\_\+\+THROWS\+\_\+\+MATCHES($\ast$$\ast$ {\itshape expression}, {\itshape exception type}, {\itshape matcher for given exception type} $\ast$$\ast$)}}
\end{DoxyItemize}
...
\end{DoxyCode}
\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md15}{}\doxysubsection{Matcher expressions}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md15}
To support Matchers a slightly different form is used. Matchers have \href{matchers.md\#top}{\texttt{ their own documentation}}.


\begin{DoxyItemize}
\item {\bfseries{REQUIRE\+\_\+\+THAT($\ast$$\ast$ {\itshape lhs}, {\itshape matcher expression} $\ast$$\ast$)}} and ~\newline

\item {\bfseries{CHECK\+\_\+\+THAT($\ast$$\ast$ {\itshape lhs}, {\itshape matcher expression} $\ast$$\ast$)}} ~\newline

\end{DoxyItemize}

Matchers can be composed using {\ttfamily \&\&}, {\ttfamily $\vert$$\vert$} and {\ttfamily !} operators.\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md16}{}\doxysubsection{Thread Safety}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md16}
Currently assertions in Catch are not thread safe. For more details, along with workarounds, see the section on \href{limitations.md\#thread-safe-assertions}{\texttt{ the limitations page}}.\hypertarget{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md17}{}\doxysubsection{Expressions with commas}\label{md_ext_2hera_2extern_2_catch2_2docs_2assertions_autotoc_md17}
